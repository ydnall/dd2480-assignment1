...
#     return Parameters(
#         LENGTH1=0, RADIUS1=radius1, EPSILON=0, AREA1=0,
...
# def test_lic_1_collinear_points():
#     """Collinear points cannot be enclosed by any finite radius"""
#     points = [(0, 0), (1, 0), (2, 0)]
...
#     points = [
#         (0, 0), (0.5, 0), (0, 0.5),   # small triangle
#         (0, 0), (5, 0), (0, 5)        # large triangle
#     ]
#     params = make_params(radius1=1.0)
#     assert lic_1(points, params) == True
